...
public class TesteApp {
	...
	public static void main(String[] args) {
		...
		String coordenadasSensores[] = { "47°55'44\"W,21°00'34\"S", "47°55'42\"W,21°00'35\"S",
				"47°55'39\"W,21°00'37\"S", "47°55'44\"W,21°00'39\"S", "47°55'40\"W,21°00'40\"S",
				"47°55'32\"W,21°00'34\"S", "47°55'28\"W,21°00'34\"S", "47°55'28\"W,21°00'38\"S",
		...
		for (int i = 0; i < n; i++) {
			...
			Sensores nSensor = new Sensores(i, coordenadasSensores[i], umidade, ph, potassio, temp);
		...
		do {
			...
			System.out.println("1 - Criar Sensor");
